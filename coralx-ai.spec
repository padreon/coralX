...
"""
PyInstaller spec for coralX — AI bundle variant.
Includes ultralytics + PyTorch so AI auto-label works offline, no pip needed.

Build (requires ultralytics installed first):
    pip install "ultralytics>=8.0.0"
    pyinstaller coralx-ai.spec

Output:
    dist/coralX-ai/         (Linux / macOS)
    dist/coralX-ai/         (Windows — contains coralX.exe)
...
# ---------------------------------------------------------------------------
# Qt modules coralX does NOT use — same exclusion list as base spec
# ---------------------------------------------------------------------------
_EXCLUDED_QT = [
